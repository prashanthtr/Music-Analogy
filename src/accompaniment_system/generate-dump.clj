...
(defn gen-subsumption [Sol accent subst st]
  ...
  (let [ pos (sort (notChangeRule (positions Sol) accent) ) newSol (var-sub (apply-rule-map Sol) pos 0 subst)
        ]
...
;; the combinations array gives the different perception of the lead that are possible by the secondary
